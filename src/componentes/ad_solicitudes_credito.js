...
class Ad_solicitudes_credito extends React.Component{
    constructor(){
        ...
        <div>
            ...
            <ul className="nav nav-tabs">
                <li className="nav-item">
                    <a className="nav-link active" aria-current="page" href="/ad_solicitudes_credito">Solicitudes</a>
                </li>
                <li className="nav-item">
            ...
            <div className="contenido3">
                ...
                <table className="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td><a href="#" onClick={() => {window.open('/ad_modificar_solicitud', 'popup', 'top=100, left=100, width=599, height=680, toolbar=NO, resizable=NO,scrollbars=no, locationbar=no, Location=NO, Menubar=NO, Titlebar=No, status=yes, Status=NO')}}><img src={logo8} className="img-fluid" alt="Eniun" align="center" width="40px" height="40px"/></a></td>
                    </tr>
...
export default Ad_solicitudes_credito;