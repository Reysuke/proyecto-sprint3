...
class Ad_creditos_vigentes extends React.Component{
    constructor(){
    ...
    return(
        ...
        <div>
            ...
            <ul className="nav nav-tabs">
                ...
                <li className="nav-item">
                    <a className="nav-link active" aria-current="page" href="/ad_creditos_vigentes">Creditos Vigentes</a>
                </li>
                <li className="nav-item">
...
export default Ad_creditos_vigentes;