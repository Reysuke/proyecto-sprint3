...
class Ui_historial_pagos extends React.Component{
    constructor(){
    ...
    return(
        ...
        <div>
            ...
            <ul className="nav nav-tabs">
                ...
                <li className="nav-item">
                    <a className="nav-link active" aria-current="page" href="/ui_historial_pagos">Historial de pagos</a>
                </li>
                    ...
                    <div className="contenido3">
                        ...
                        <table className="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td><a href="#" onClick={() => {window.open('/ui_ver_historial', 'popup', 'top=100, left=100, width=599, height=680, toolbar=NO, resizable=NO,scrollbars=no, locationbar=no, Location=NO, Menubar=NO, Titlebar=No, status=yes, Status=NO')}}><img src={logo9} className="img-fluid" alt="Eniun" align="center" width="20px" height="20px"/></a></td>
...
export default Ui_historial_pagos;