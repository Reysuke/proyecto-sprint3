...
class Ad_registrar_usuarios extends React.Component{
    constructor(){
        ...
        <div>
            ...
            <div className="p-2 mb-2 bg-warning text-white " >
                ...
                <div className="row ">
                    ...
                    <div class="padre3">
                    <button type="button" className="btn btn-primary boton_modificar" onClick={() => this.guardar()}>REGISTRAR</button>
...
export default Ad_registrar_usuarios;